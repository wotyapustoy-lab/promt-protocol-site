                ...
                >
                    ...
                    >
                        ...
                        <div style={styles.headerInfo}>
                            <p>Released: 28/10/2025</p>
                            <p>PROMTBIOS (C)2025 IURIIDev Inc.</p>
                        </div>
                    </div>
                    <div style={styles.body} className="loading-screen-body">
                        <p>HSP S13 2025 Special RU 015649</p>
                        <div style={styles.spacer} />
                        {showBiosInfo && (
                            <>
                                <p>HSP Showcase(tm) XX 113</p>
                                <p>Checking RAM : {69} OK</p>
                                <p>Detecting neural co-processor : PROMT OS beta v0.1 ... OK</p>
                                <p>Loading identity signature ... <b style={styles.green}>GHNFTees VERIFIED</b></p>
                                <p>Syncing belief layer : <span style={styles.orange}>God Hates Empty Promises</span> ... done</p>
                                <div style={styles.spacer} />
                                <div style={styles.spacer} />
                        ...
                        {showLoadingResources && doneLoading && (
                            <p>
                                &gt;_ All content loaded. launching PROMT core...{' '}
                                <b style={styles.green}>'connected to GHNFTees protocol subnet'</b>{' '}
                                    'member of the GodHatesNFTees'
                                <span className="comment"># stay loud. stay free. We are GodHatesNFTees</span>
                                Promt OS Beta v0.1 powered by IURIIdev
                            </p>
                        )}
                        <div style={styles.spacer} />
                        <span className="blinking-cursor" />
                    ...
                    >
                        <p>
                            &gt;_ Press DEL for setup • ESC to skip • promt OS beta v0.1 © IURIIdev
                        </p>
                        <p>{getCurrentDate()}</p>
                    </div>
                </div>
            ...
            >
                <div style={styles.startPopup}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'flex-end' }}>
                        <p>&gt;_ click start to awaken promt core{'\xa0'}</p>
                        <span className="blinking-cursor" />
                    </div>
                    <div
                        style={{
